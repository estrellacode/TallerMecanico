...
import 'package:tallermecanico/almacen/interfaces/regresos.dart';
import 'package:tallermecanico/almacen/interfaces/salidas.dart';

class Principalalmacen extends StatefulWidget {
  const Principalalmacen({super.key});

  @override
  State<Principalalmacen> createState() => _PrincipalalmacenState();
}

class _PrincipalalmacenState extends State<Principalalmacen> {
