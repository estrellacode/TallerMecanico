...
import 'package:tallermecanico/almacen/interfaces/salidasproductos.dart';

// Ajusta estos imports a tus rutas reales:
import 'package:tallermecanico/almacen/models/models_folios.dart';
import 'package:tallermecanico/almacen/services/service_folios.dart'; // debe exponer FoliosService().fetchFolios()

// ====== PANTALLA: SALIDAS (antes "Regresos") ======
class Salidas extends StatefulWidget {
  const Salidas({super.key});
...
class _SalidasState extends State<Salidas> {
  ...
  static const double wEconomico = 200;
  static const double wChofer = 420;
  static const double totalTableWidth = wFolio + wEconomico + wChofer;

  final _hScrollCtrl = ScrollController();
  final service =
      FoliosService(); // debe tener fetchFolios(): Future<List<Folios>>
                  ...
                  children: [
                    ...
                    monochromeCard(
                      ...
                      child: Column(
                        ...
                        children: [
                          const InfoRow(label: 'Movimiento:', value: 'Salidas'),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: const [
                      SizedBox(
                        width: _SalidasState.wFolio,
                        child: _HeaderCell('Folio'),
                      ),
                      SizedBox(
                        width: _SalidasState.wEconomico,
                        child: _HeaderCell('Económico'),
                      ),
                      SizedBox(
                        width: _SalidasState.wChofer,
                ...
                SizedBox(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, i) {
                      ...
                      // ahora chofer viene de "descripcion" → empleado
                      final choferTxt = _formateaNombre(
                        (f.empleado ?? '').trim(),
                      );
