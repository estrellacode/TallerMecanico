...
class Regresosproductos extends StatefulWidget {
  final String folio;
  final String chofer;
  final String? economico;

  const Regresosproductos({
    super.key,
    required this.folio,
  ...
  @override
  State<Regresosproductos> createState() => _RegresosproductosState();
}

class _RegresosproductosState extends State<Regresosproductos>
    with WidgetsBindingObserver
    implements ScannerCallback {
  // Código QR actual (escaneado o escrito)
  String? codigoQr;
  ...
  Future<void> onDecoded(ScannedData? data) async {
    ...
    if (escribirManual) return; // si está escribiendo, ignora el escaneo
            ...
            children: [
              ...
              monochromeCard(
                ...
                child: Column(
                  ...
                  children: [
                    const _HdrRow(label: 'Movimiento:', value: 'Regresos'),
